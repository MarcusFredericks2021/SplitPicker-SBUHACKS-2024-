    ...
    return (
        <SimpleGrid columns={2} spacing={10} height="100vh" bgRepeat="no-repeat" bgSize="100% 100%" position="relative">
            <Box height='full' p="6" paddingTop="110" paddingLeft="50" fontSize='3xl' color='white' style={{ fontFamily: "monospace" }}><Heading style={{ fontStyle: "italic", fontFamily: "monospace" }} >About Us</Heading>
                We wanted to create this web application to reduce the time it takes to get a proper gym schedule and actually get someone into the gym. We combined all of our experiences with the help of studies to make a scoring system! Started during SBUHacks2024.
            </Box>
            ...
            <Text>Credits (So Far Hopefully): Marcus Fredericks, Jason Hamechan, Saatvik Sandal, Christopher Kim</Text>
        </SimpleGrid>
    )
}
